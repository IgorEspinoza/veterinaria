...
public class Datos extends javax.swing.JFrame {
    ...
    Connection cn2 = cn.conexion();
    
    void mostrar(){
        DefaultTableModel modelo = new DefaultTableModel();
        modelo.addColumn("Num_Ficha");
        ...
        modelo.addColumn("Nom_Dueno");
        modelo.addColumn("Fono");
        jTable3.setModel(modelo);
        
        String sql = "SELECT * FROM mascota WHERE num_ficha = "+jTextField9.getText()+"";
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero_Ficha", "Edad", "Vacuna", "Peso", "Altura", "Tipo", "Clasificacion", "Nombre_Dueño", "Fono"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            PreparedStatement pss = cn2.prepareStatement("INSERT into veterinaria_duoc.mascota (edad,vacuna,peso,altura,tipo,clasificacion,nom_dueno,fono) VALUE (?,?,?,?,?,?,?,?)");
            pss.setString(1,jTextField1.getText());
            pss.setString(2,jTextField2.getText());
            pss.setString(3,jTextField3.getText());
            pss.setString(4,jTextField4.getText());
            pss.setString(5,jTextField5.getText());
            pss.setString(6,jTextField6.getText());
            pss.setString(7,jTextField7.getText());
            pss.setString(8,jTextField8.getText());
            pss.executeUpdate();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String query = "update mascota set nom_dueno = ?, edad = ? WHERE num_ficha = "+jTextField9.getText()+"";
        try{
            PreparedStatement preparedStmt = cn2.prepareStatement(query);
            preparedStmt.setString(1, JOptionPane.showInputDialog("nombre Dueño ↓"));
            preparedStmt.setInt(2, Integer.parseInt(JOptionPane.showInputDialog("Edad Mascota ↓")));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
                String query = "DELETE FROM veterinaria_duoc.mascota WHERE num_ficha = "+jTextField9.getText()+"";
        try{
            PreparedStatement preparedStmt = cn2.prepareStatement(query);
            preparedStmt.execute();
